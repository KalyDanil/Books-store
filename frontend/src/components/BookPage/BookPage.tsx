...
import {nameChangerAction} from '../../store/reducers/user';
...
import {
    ...
    getRecommendationsRequest} from '../../store/reducers/books';
...
function BookPage() {
    ...
    const getSelectedBook = async () => {
        ...
        await dispatch<any>(getSelectedBookRequest(reqParams));
    ...
    const getRecommendations = async () => {
        ...
        dispatch<any>(getRecommendationsRequest(params))
    }
    ...
    const submitComment = async () => {
        ...
        await dispatch<any>(makeCommentRequest(body));
    }

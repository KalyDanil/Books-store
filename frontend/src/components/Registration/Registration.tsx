...
import {registrationRequest} from '../../store/reducers/user';
...
function Registration() {
    ...
    function emailInput (e: React.ChangeEvent<HTMLInputElement>) {
    ...
    function passwordReplayInput (e: React.ChangeEvent<HTMLInputElement>) {

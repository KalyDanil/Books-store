...
import {getAllBooksRequest} from '../../store/reducers/books';

function MainPage() {
    const books = useSelector((state: RootState) => state.books);
    const dispatch = useDispatch();
    const [allBooks, setAllBooks] = useState([{id: 1, title: '', author: '', price: 1.1, rating: 0, dateOfIssue: '', cover: '', status: ''}]);
    ...
    async function getAllBooks() {
        await dispatch<any>(getAllBooksRequest());
        // setAllBooks(res.payload);
    }

    // getAllBooks()

    async function editGenre(e: any) {
                ...
                <div className='catalog__header'>
                    ...
                    <div className='catalog__header-select'>
                        ...
                        <div className='header-select__sortBy'>
                            <input className='select-sortBy__button' type='button' value='Sort by' onClick={editSort} onBlur={editNothing}></input>

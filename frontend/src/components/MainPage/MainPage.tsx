...
import { getBooksRequest, getAllGenresRequest, getMinMaxPriceRequest, getPageAction } from '../../store/reducers/bookReducer/thunks';
...
const MainPage: React.FC = () => {
    ...
    const getAllGenres = async () => {
        await dispatch(getAllGenresRequest());
    }
    ...
    useEffect(() => {
        dispatch(getMinMaxPriceRequest());

import { api } from ".";
import { IAddBookToCartReq, IBook, IChangeRatingReq, IComment, IDeleteBookFromCartReq, IGetBooksReq, IGetCartBooksReq, IGetLikedBooksReq, IGetRecommendationsReq, IGetSelectedBookReq, IMakeCommentReq, IToLikeBookReq, TBooksResponse, TCartBooksResponse, TGenresResponse } from "../utils/types";
